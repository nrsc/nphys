...
The nphys package provides a means to easily manage, analyze, and observe data collected during electrophysiology experiments, while also keeping a well organized overall project.

It is geared towards developing robust and portable data management tools that can easily incoprate various methods of analysis . It also serves as a tool to encourages regularly revisiting data, by helping to manage large data sets in a way that organizes and presents comprehensive summaries that can be rapidly updated and observed from many different angles.
