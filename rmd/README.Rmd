...
The nphys package provides a means to easily analyze and view electrophysiology data, while also and a tools for managing your project.

It is geared towards developing robust and portable data management tools that can easily call on various methods of analysis.
