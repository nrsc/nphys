...
mat <- as.data.frame(readMat(lf)) %>% # Original DAT file projRTT_2019-08-20_004.dat; A1_CCinj_9
...
pNum <- which(Pros$Samples == nrow(mat))
Channels <- str_split(pro$Channels[pNum], pattern = ";", simplify = TRUE)
