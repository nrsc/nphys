...
The nphys package is geared towares developing robust and portable data management and analysis tools for electrophysiology data. The package provides a means to easily analyze and view experimental data while also integrating tools for managing your overall project.
