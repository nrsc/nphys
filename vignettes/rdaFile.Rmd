...
This vignette is going to first outline building a typical dataset generated during a field electrophysiology experiment, followed up by examining the dataset and looking at examples of how we can work with built in functions to navigate the environment

All examples outlined in this work reference the project directory and utilizes the built in `field` dataset.
